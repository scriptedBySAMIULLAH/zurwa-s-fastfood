...
function Footer() {
  return (
    <>
      <main
        className="flex w-full flex-col   border justify-around bg-footerBg text-white py-4
        ...
        <section className=" grid grid-cols-1  sm:grid-cols-2 gap-6">
          <div className="max-w-sm">
            <img
              ...
              className="w-full h-64 rounded-2xl shadow-xl object-cover"
            />
          </div>
          <div>
            <ul className="h-full flex flex-col justify-center items-center space-y-6 font-bold cursor-pointer">
